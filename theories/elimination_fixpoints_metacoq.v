...
Ltac eliminate_fix_ho_metacoq H := fun k =>
first [
let T := type of H in
...
Ltac eliminate_fix_hyp_metacoq H := eliminate_fix_ho_metacoq H ltac:(fun _ => idtac).
...
get_def Nat.add.
expand_hyp add_def.
eliminate_fix_hyp_metacoq H.
expand_hyp length_def.
eliminate_fix_hyp_metacoq H1.
Abort.
...
eliminate_fix_hyp_metacoq H.
expand_hyp add_def.
eliminate_fix_ho_metacoq H ltac:(fun H0 => let t := type of H0 in idtac).
expand_hyp length_def.
eliminate_fix_hyp_metacoq H.
Abort.
